...
# Generic patch-stack primitives shared by the CEF and Nucleus Browser
# products. Callers own source preparation and choose which product layers to
# apply.
...
nucleus_reverse_patch_stack() {
  ...
  # The generated copy records the exact stack last applied. This lets a
  # renamed, merged, or deleted patch be reversed before the new stack lands.
