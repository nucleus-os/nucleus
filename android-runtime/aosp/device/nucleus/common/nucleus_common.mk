...
PRODUCT_COPY_FILES += \
    device/nucleus/common/sysconfig/oem-defined-uids-nucleus.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/sysconfig/oem-defined-uids-nucleus.xml \
    device/nucleus/common/sysconfig/package-shareduid-allowlist-nucleus.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/sysconfig/package-shareduid-allowlist-nucleus.xml \
    device/nucleus/common/sysconfig/privapp-permissions-nucleus.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-nucleus.xml
...
$(call inherit-product, device/nucleus/common/device.mk)
