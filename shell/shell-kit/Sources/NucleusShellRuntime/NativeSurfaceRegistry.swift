...
@safe final class NativeSurfaceRegistry {
    ...
    func configure(
        ...
        if let renderOutputID = record.renderOutputID {
            ...
            let renderOutputID = engine.addSurface(
