...
@Test func checkedInTargetSDKLockHasExactDestinations() throws {
    ...
    #expect(lock.ubuntuPackages.count == 19)
    ...
    #expect(lock.ubuntuPackages.contains { $0.url.contains("libxml2-dev_") })
    #expect(lock.ubuntuPackages.contains { $0.url.contains("/libxml2_") })
