...
func macOSCommandCompositionContainsOnlyWorkspaceOperations() {
    let expectedRoot: [ParsableCommand.Type] = [
        ...
        Generate.self, Adopt.self, PackageArtifacts.self, Provision.self, Skill.self,
        Benchmark.self, Clean.self, Cache.self, Tasks.self, Graph.self, Runs.self,
        Logs.self, Status.self,
    ]
