...
WL_EXPORT const struct wl_interface zwlr_output_manager_v1_interface = {
...
WL_EXPORT const struct wl_interface zwlr_output_head_v1_interface = {
...
WL_EXPORT const struct wl_interface zwlr_output_mode_v1_interface = {
...
WL_EXPORT const struct wl_interface zwlr_output_configuration_v1_interface = {
...
WL_EXPORT const struct wl_interface zwlr_output_configuration_head_v1_interface = {
