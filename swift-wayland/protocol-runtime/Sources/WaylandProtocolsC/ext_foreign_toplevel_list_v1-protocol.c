...
WL_EXPORT const struct wl_interface ext_foreign_toplevel_list_v1_interface = {
...
WL_EXPORT const struct wl_interface ext_foreign_toplevel_handle_v1_interface = {
