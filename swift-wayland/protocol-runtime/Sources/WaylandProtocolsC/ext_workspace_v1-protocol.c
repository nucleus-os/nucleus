...
WL_EXPORT const struct wl_interface ext_workspace_manager_v1_interface = {
...
WL_EXPORT const struct wl_interface ext_workspace_group_handle_v1_interface = {
...
WL_EXPORT const struct wl_interface ext_workspace_handle_v1_interface = {
