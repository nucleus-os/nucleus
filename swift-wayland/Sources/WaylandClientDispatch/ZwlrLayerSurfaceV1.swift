...
public enum ZwlrLayerSurfaceV1Client {
    public nonisolated(unsafe) static let listener: UnsafeMutablePointer<zwlr_layer_surface_v1_listener> = {
        let p = UnsafeMutablePointer<zwlr_layer_surface_v1_listener>.allocate(capacity: 1)
        p.initialize(to: zwlr_layer_surface_v1_listener())
