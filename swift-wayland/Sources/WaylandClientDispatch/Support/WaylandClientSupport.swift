...
public enum WaylandProxyError: Error, Equatable {
  case destroyed
...
@safe public final class WaylandClientConnectionLifetime {
...
@MainActor
@safe
public final class WaylandProxy<
...
> {
  ...
  /// destructor request.
  public func destroyLocally() throws(WaylandProxyError) {
  ...
  @unsafe
  public func withUnsafeNativeProxy<
    Result: ~Copyable,
    Failure: Error
  >(
...
@safe
public struct WaylandBorrowedProxy<
  Interface: WaylandClientInterface
>: ~Escapable {
...
@safe public struct WaylandClientArrayArgument {
