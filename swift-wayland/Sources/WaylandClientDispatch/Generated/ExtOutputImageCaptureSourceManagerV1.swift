...
package enum ExtOutputImageCaptureSourceManagerV1Client: WaylandClientInterface {
...
extension WaylandProxy where Interface == ExtOutputImageCaptureSourceManagerV1Client {
        ...
        -> WaylandProxy<ExtImageCaptureSourceV1Client>
    {
        ...
        guard
            let _created =
                unsafe swift_wayland_client_request_ext_output_image_capture_source_manager_v1_create_source(
                    _proxy, _outputProxy)
        else {
    ...
    package func destroy() throws(WaylandProxyError) {
        ...
        let _send = { () throws(WaylandProxyError) -> Void in
            unsafe swift_wayland_client_request_ext_output_image_capture_source_manager_v1_destroy(
                _proxy)
            return
        }
        try _send()
