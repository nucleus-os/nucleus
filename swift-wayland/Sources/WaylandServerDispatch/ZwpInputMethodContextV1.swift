...
@MainActor public protocol ZwpInputMethodContextV1Requests: AnyObject {
...
public enum ZwpInputMethodContextV1Server: WaylandServerInterface {
...
public extension WaylandResourceHandle where Interface == ZwpInputMethodContextV1Server {
    @discardableResult
...
public extension WlNewId where Interface == ZwpInputMethodContextV1Server {
    @discardableResult
    @MainActor
    func create<Owner: ZwpInputMethodContextV1Requests>(
        ...
        unsafe _create(vtable: ZwpInputMethodContextV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ZwpInputMethodContextV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ZwpInputMethodContextV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ZwpInputMethodContextV1Server.self,
