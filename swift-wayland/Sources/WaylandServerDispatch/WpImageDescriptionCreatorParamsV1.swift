...
public extension WlNewId where Interface == WpImageDescriptionCreatorParamsV1Server {
    ...
    func create<Owner: WpImageDescriptionCreatorParamsV1Requests>(
        ...
        unsafe _create(vtable: WpImageDescriptionCreatorParamsV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension WpImageDescriptionCreatorParamsV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: WpImageDescriptionCreatorParamsV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: WpImageDescriptionCreatorParamsV1Server.self,
