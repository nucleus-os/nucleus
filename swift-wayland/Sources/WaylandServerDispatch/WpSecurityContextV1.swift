...
@MainActor public protocol WpSecurityContextV1Requests: AnyObject {
...
public enum WpSecurityContextV1Server: WaylandServerInterface {
...
public extension WaylandRequest where Interface == WpSecurityContextV1Server {
    func postError(_ code: WpSecurityContextV1Error, message: String) {
        postError(code: code.rawValue, message: message)
    }
}
public extension WaylandResourceHandle where Interface == WpSecurityContextV1Server {
    @discardableResult
    func postError(_ code: WpSecurityContextV1Error, message: String) -> Bool {
        postError(code: code.rawValue, message: message)
    }
}
public extension WlNewId where Interface == WpSecurityContextV1Server {
    @discardableResult
    @MainActor
    func create<Owner: WpSecurityContextV1Requests>(
        ...
        unsafe _create(vtable: WpSecurityContextV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension WpSecurityContextV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: WpSecurityContextV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: WpSecurityContextV1Server.self,
