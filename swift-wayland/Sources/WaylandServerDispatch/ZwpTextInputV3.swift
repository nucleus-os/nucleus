...
@MainActor public protocol ZwpTextInputV3Requests: AnyObject {
...
public enum ZwpTextInputV3Server: WaylandServerInterface {
    ...
    public static func sendAction(_ target: UnsafeMutablePointer<wl_resource>, action: ZwpTextInputV3Action, serial: UInt32) {
    ...
    public static func sendPreeditHint(_ target: UnsafeMutablePointer<wl_resource>, start: UInt32, end: UInt32, hint: ZwpTextInputV3PreeditHint) {
...
public extension WaylandResourceHandle where Interface == ZwpTextInputV3Server {
...
public extension WaylandRequest where Interface == ZwpTextInputV3Server {
...
public extension WlNewId where Interface == ZwpTextInputV3Server {
    @discardableResult
    @MainActor
    func create<Owner: ZwpTextInputV3Requests>(
        ...
        unsafe _create(vtable: ZwpTextInputV3Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ZwpTextInputV3Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ZwpTextInputV3Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ZwpTextInputV3Server.self,
