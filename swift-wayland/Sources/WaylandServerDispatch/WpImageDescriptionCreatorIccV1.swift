...
public enum WpImageDescriptionCreatorIccV1Server {
    ...
    private static func handler(_ res: UnsafeMutablePointer<wl_resource>) -> WpImageDescriptionCreatorIccV1Requests? {
        guard let ud = wl_resource_get_user_data(res) else { return nil }
        return Unmanaged<AnyObject>.fromOpaque(ud).takeUnretainedValue() as? WpImageDescriptionCreatorIccV1Requests
    }
