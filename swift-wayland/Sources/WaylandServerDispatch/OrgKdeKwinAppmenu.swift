...
public extension WlNewId where Interface == OrgKdeKwinAppmenuServer {
    ...
    func create<Owner: OrgKdeKwinAppmenuRequests>(
        ...
        unsafe _create(vtable: OrgKdeKwinAppmenuServer.requestVtable(), owner: owner, installed: installed)
    }
}
public extension OrgKdeKwinAppmenuServer {
    @discardableResult
    @MainActor
    static func createResource<Owner: OrgKdeKwinAppmenuRequests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: OrgKdeKwinAppmenuServer.self,
