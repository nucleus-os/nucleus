...
@MainActor public protocol OrgKdeKwinBlurRequests: AnyObject {
...
public enum OrgKdeKwinBlurServer: WaylandServerInterface {
...
public extension WlNewId where Interface == OrgKdeKwinBlurServer {
    @discardableResult
    @MainActor
    func create<Owner: OrgKdeKwinBlurRequests>(
        ...
        unsafe _create(vtable: OrgKdeKwinBlurServer.requestVtable(), owner: owner, installed: installed)
    }
}
public extension OrgKdeKwinBlurServer {
    @discardableResult
    @MainActor
    static func createResource<Owner: OrgKdeKwinBlurRequests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: OrgKdeKwinBlurServer.self,
