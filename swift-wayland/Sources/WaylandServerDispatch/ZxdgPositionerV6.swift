...
@MainActor public protocol ZxdgPositionerV6Requests: AnyObject {
...
public enum ZxdgPositionerV6Server: WaylandServerInterface {
...
public extension WaylandRequest where Interface == ZxdgPositionerV6Server {
    func postError(_ code: ZxdgPositionerV6Error, message: String) {
        postError(code: code.rawValue, message: message)
    }
}
public extension WaylandResourceHandle where Interface == ZxdgPositionerV6Server {
    @discardableResult
    func postError(_ code: ZxdgPositionerV6Error, message: String) -> Bool {
        postError(code: code.rawValue, message: message)
    }
}
public extension WlNewId where Interface == ZxdgPositionerV6Server {
    @discardableResult
    @MainActor
    func create<Owner: ZxdgPositionerV6Requests>(
        ...
        unsafe _create(vtable: ZxdgPositionerV6Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ZxdgPositionerV6Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ZxdgPositionerV6Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ZxdgPositionerV6Server.self,
