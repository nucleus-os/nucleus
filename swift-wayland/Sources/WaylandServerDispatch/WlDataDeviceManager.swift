...
@MainActor public protocol WlDataDeviceManagerRequests: AnyObject {
...
public enum WlDataDeviceManagerServer: WaylandServerInterface {
...
public extension WlNewId where Interface == WlDataDeviceManagerServer {
    @discardableResult
    @MainActor
    func create<Owner: WlDataDeviceManagerRequests>(
        ...
        unsafe _create(vtable: WlDataDeviceManagerServer.requestVtable(), owner: owner, installed: installed)
    }
}
public extension WlDataDeviceManagerServer {
    @discardableResult
    @MainActor
    static func createResource<Owner: WlDataDeviceManagerRequests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: WlDataDeviceManagerServer.self,
