...
public extension WlNewId where Interface == XdgWmBaseServer {
    ...
    func create<Owner: XdgWmBaseRequests>(
        ...
        unsafe _create(vtable: XdgWmBaseServer.requestVtable(), owner: owner, installed: installed)
    }
}
public extension XdgWmBaseServer {
    @discardableResult
    @MainActor
    static func createResource<Owner: XdgWmBaseRequests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: XdgWmBaseServer.self,
