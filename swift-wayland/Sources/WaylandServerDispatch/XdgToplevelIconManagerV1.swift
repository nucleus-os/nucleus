...
@MainActor public protocol XdgToplevelIconManagerV1Requests: AnyObject {
...
public enum XdgToplevelIconManagerV1Server: WaylandServerInterface {
...
public extension WaylandResourceHandle where Interface == XdgToplevelIconManagerV1Server {
    @discardableResult
...
public extension WlNewId where Interface == XdgToplevelIconManagerV1Server {
    @discardableResult
    @MainActor
    func create<Owner: XdgToplevelIconManagerV1Requests>(
        ...
        unsafe _create(vtable: XdgToplevelIconManagerV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension XdgToplevelIconManagerV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: XdgToplevelIconManagerV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: XdgToplevelIconManagerV1Server.self,
