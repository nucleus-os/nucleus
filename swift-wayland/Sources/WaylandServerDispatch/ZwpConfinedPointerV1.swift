...
public enum ZwpConfinedPointerV1Server {
    public nonisolated(unsafe) static let vtable: UnsafeRawPointer = {
        ...
        let vt = raw.bindMemory(to: swift_wayland_zwp_confined_pointer_v1_requests.self, capacity: 1)
    ...
    public static func sendConfined(_ target: UnsafeMutablePointer<wl_resource>) {
        zwp_confined_pointer_v1_send_confined(target)
    }
