...
@MainActor public protocol ZwpConfinedPointerV1Requests: AnyObject {
...
public extension ZwpConfinedPointerV1Requests {
    func destroy(_ request: WaylandRequest<ZwpConfinedPointerV1Server>) {
        unsafe wl_resource_destroy(request.resource)
    }
}
public enum ZwpConfinedPointerV1Server: WaylandServerInterface {
    ...
    public static func sendConfined(_ target: UnsafeMutablePointer<wl_resource>) {
        unsafe zwp_confined_pointer_v1_send_confined(target)
    }
    public static func sendUnconfined(_ target: UnsafeMutablePointer<wl_resource>) {
...
public extension WaylandResourceHandle where Interface == ZwpConfinedPointerV1Server {
    @discardableResult
...
public extension WlNewId where Interface == ZwpConfinedPointerV1Server {
    @discardableResult
    @MainActor
    func create<Owner: ZwpConfinedPointerV1Requests>(
        ...
        unsafe _create(vtable: ZwpConfinedPointerV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ZwpConfinedPointerV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ZwpConfinedPointerV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ZwpConfinedPointerV1Server.self,
