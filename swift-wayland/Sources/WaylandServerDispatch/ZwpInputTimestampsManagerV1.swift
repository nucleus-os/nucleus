...
@MainActor public protocol ZwpInputTimestampsManagerV1Requests: AnyObject {
...
public enum ZwpInputTimestampsManagerV1Server: WaylandServerInterface {
...
public extension WlNewId where Interface == ZwpInputTimestampsManagerV1Server {
    @discardableResult
    @MainActor
    func create<Owner: ZwpInputTimestampsManagerV1Requests>(
        ...
        unsafe _create(vtable: ZwpInputTimestampsManagerV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ZwpInputTimestampsManagerV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ZwpInputTimestampsManagerV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ZwpInputTimestampsManagerV1Server.self,
