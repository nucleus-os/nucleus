...
@MainActor public protocol WpColorManagerV1Requests: AnyObject {
...
public enum WpColorManagerV1Server: WaylandServerInterface {
    ...
    public static func sendSupportedIntent(_ target: UnsafeMutablePointer<wl_resource>, render_intent: WpColorManagerV1RenderIntent) {
        unsafe wp_color_manager_v1_send_supported_intent(target, render_intent.rawValue)
    }
    public static func sendSupportedFeature(_ target: UnsafeMutablePointer<wl_resource>, feature: WpColorManagerV1Feature) {
        unsafe wp_color_manager_v1_send_supported_feature(target, feature.rawValue)
    }
    public static func sendSupportedTfNamed(_ target: UnsafeMutablePointer<wl_resource>, tf: WpColorManagerV1TransferFunction) {
        unsafe wp_color_manager_v1_send_supported_tf_named(target, tf.rawValue)
    }
    public static func sendSupportedPrimariesNamed(_ target: UnsafeMutablePointer<wl_resource>, primaries: WpColorManagerV1Primaries) {
...
public extension WaylandResourceHandle where Interface == WpColorManagerV1Server {
    @discardableResult
...
public extension WaylandRequest where Interface == WpColorManagerV1Server {
...
public extension WlNewId where Interface == WpColorManagerV1Server {
    @discardableResult
    @MainActor
    func create<Owner: WpColorManagerV1Requests>(
        ...
        unsafe _create(vtable: WpColorManagerV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension WpColorManagerV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: WpColorManagerV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: WpColorManagerV1Server.self,
