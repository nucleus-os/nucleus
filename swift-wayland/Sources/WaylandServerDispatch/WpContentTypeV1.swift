...
@MainActor public protocol WpContentTypeV1Requests: AnyObject {
...
public enum WpContentTypeV1Server: WaylandServerInterface {
...
public extension WlNewId where Interface == WpContentTypeV1Server {
    @discardableResult
    @MainActor
    func create<Owner: WpContentTypeV1Requests>(
        ...
        unsafe _create(vtable: WpContentTypeV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension WpContentTypeV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: WpContentTypeV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: WpContentTypeV1Server.self,
