...
@MainActor public protocol ExtIdleNotifierV1Requests: AnyObject {
...
public enum ExtIdleNotifierV1Server: WaylandServerInterface {
...
public extension WlNewId where Interface == ExtIdleNotifierV1Server {
    @discardableResult
    @MainActor
    func create<Owner: ExtIdleNotifierV1Requests>(
        ...
        unsafe _create(vtable: ExtIdleNotifierV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ExtIdleNotifierV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ExtIdleNotifierV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ExtIdleNotifierV1Server.self,
