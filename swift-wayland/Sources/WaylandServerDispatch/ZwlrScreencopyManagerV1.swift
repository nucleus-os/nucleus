...
@MainActor public protocol ZwlrScreencopyManagerV1Requests: AnyObject {
...
public enum ZwlrScreencopyManagerV1Server: WaylandServerInterface {
...
public extension WlNewId where Interface == ZwlrScreencopyManagerV1Server {
    @discardableResult
    @MainActor
    func create<Owner: ZwlrScreencopyManagerV1Requests>(
        ...
        unsafe _create(vtable: ZwlrScreencopyManagerV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ZwlrScreencopyManagerV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ZwlrScreencopyManagerV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ZwlrScreencopyManagerV1Server.self,
