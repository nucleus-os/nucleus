...
@MainActor public protocol WlShmPoolRequests: AnyObject {
...
public enum WlShmPoolServer: WaylandServerInterface {
...
public extension WlNewId where Interface == WlShmPoolServer {
    @discardableResult
    @MainActor
    func create<Owner: WlShmPoolRequests>(
        ...
        unsafe _create(vtable: WlShmPoolServer.requestVtable(), owner: owner, installed: installed)
    }
}
public extension WlShmPoolServer {
    @discardableResult
    @MainActor
    static func createResource<Owner: WlShmPoolRequests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: WlShmPoolServer.self,
