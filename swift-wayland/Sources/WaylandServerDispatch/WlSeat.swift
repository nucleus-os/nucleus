...
@MainActor public protocol WlSeatRequests: AnyObject {
...
public enum WlSeatServer: WaylandServerInterface {
    ...
    public static func sendCapabilities(_ target: UnsafeMutablePointer<wl_resource>, capabilities: WlSeatCapability) {
...
public extension WaylandResourceHandle where Interface == WlSeatServer {
...
public extension WaylandRequest where Interface == WlSeatServer {
...
public extension WlNewId where Interface == WlSeatServer {
    @discardableResult
    @MainActor
    func create<Owner: WlSeatRequests>(
        ...
        unsafe _create(vtable: WlSeatServer.requestVtable(), owner: owner, installed: installed)
    }
}
public extension WlSeatServer {
    @discardableResult
    @MainActor
    static func createResource<Owner: WlSeatRequests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: WlSeatServer.self,
