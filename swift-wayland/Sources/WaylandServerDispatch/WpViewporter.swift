...
public protocol WpViewporterRequests: AnyObject {
    ...
    func getViewport(_ resource: UnsafeMutablePointer<wl_resource>, id: WlNewId, surface: UnsafeMutablePointer<wl_resource>?)
}
...
public enum WpViewporterServer {
    public nonisolated(unsafe) static let vtable: UnsafeRawPointer = {
        ...
        let vt = raw.bindMemory(to: swift_wayland_wp_viewporter_requests.self, capacity: 1)
        vt.pointee.destroy = destroy_impl
        vt.pointee.get_viewport = getViewport_impl
