...
@MainActor public protocol ExtImageCopyCaptureManagerV1Requests: AnyObject {
...
public enum ExtImageCopyCaptureManagerV1Server: WaylandServerInterface {
...
public extension WaylandRequest where Interface == ExtImageCopyCaptureManagerV1Server {
    func postError(_ code: ExtImageCopyCaptureManagerV1Error, message: String) {
        postError(code: code.rawValue, message: message)
    }
}
public extension WaylandResourceHandle where Interface == ExtImageCopyCaptureManagerV1Server {
    @discardableResult
    func postError(_ code: ExtImageCopyCaptureManagerV1Error, message: String) -> Bool {
        postError(code: code.rawValue, message: message)
    }
}
public extension WlNewId where Interface == ExtImageCopyCaptureManagerV1Server {
    @discardableResult
    @MainActor
    func create<Owner: ExtImageCopyCaptureManagerV1Requests>(
        ...
        unsafe _create(vtable: ExtImageCopyCaptureManagerV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ExtImageCopyCaptureManagerV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ExtImageCopyCaptureManagerV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ExtImageCopyCaptureManagerV1Server.self,
