...
public protocol ZwpPointerConstraintsV1Requests: AnyObject {
    ...
    func lockPointer(_ resource: UnsafeMutablePointer<wl_resource>, id: WlNewId, surface: UnsafeMutablePointer<wl_resource>?, pointer: UnsafeMutablePointer<wl_resource>?, region: UnsafeMutablePointer<wl_resource>?, lifetime: UInt32)
    func confinePointer(_ resource: UnsafeMutablePointer<wl_resource>, id: WlNewId, surface: UnsafeMutablePointer<wl_resource>?, pointer: UnsafeMutablePointer<wl_resource>?, region: UnsafeMutablePointer<wl_resource>?, lifetime: UInt32)
}
...
public enum ZwpPointerConstraintsV1Server {
    public nonisolated(unsafe) static let vtable: UnsafeRawPointer = {
        ...
        let vt = raw.bindMemory(to: swift_wayland_zwp_pointer_constraints_v1_requests.self, capacity: 1)
        vt.pointee.destroy = destroy_impl
        vt.pointee.lock_pointer = lockPointer_impl
        vt.pointee.confine_pointer = confinePointer_impl
