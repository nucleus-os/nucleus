...
@MainActor public protocol XdgToplevelRequests: AnyObject {
...
public extension XdgToplevelRequests {
    func destroy(_ request: WaylandRequest<XdgToplevelServer>) {
        unsafe wl_resource_destroy(request.resource)
    }
}
public enum XdgToplevelServer: WaylandServerInterface {
    ...
    public static func sendConfigureBounds(_ target: UnsafeMutablePointer<wl_resource>, width: Int32, height: Int32) {
        unsafe xdg_toplevel_send_configure_bounds(target, width, height)
    }
    public static func sendWmCapabilities(_ target: UnsafeMutablePointer<wl_resource>, capabilities: UnsafeMutablePointer<wl_array>?) {
...
public extension WaylandResourceHandle where Interface == XdgToplevelServer {
...
public extension WaylandRequest where Interface == XdgToplevelServer {
...
public extension WlNewId where Interface == XdgToplevelServer {
    @discardableResult
    @MainActor
    func create<Owner: XdgToplevelRequests>(
        ...
        unsafe _create(vtable: XdgToplevelServer.requestVtable(), owner: owner, installed: installed)
    }
}
public extension XdgToplevelServer {
    @discardableResult
    @MainActor
    static func createResource<Owner: XdgToplevelRequests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: XdgToplevelServer.self,
