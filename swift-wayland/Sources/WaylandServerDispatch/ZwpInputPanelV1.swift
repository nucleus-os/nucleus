...
@MainActor public protocol ZwpInputPanelV1Requests: AnyObject {
...
public enum ZwpInputPanelV1Server: WaylandServerInterface {
    public nonisolated(unsafe) static let interface = unsafe swift_wayland_iface_zwp_input_panel_v1()
...
public extension WlNewId where Interface == ZwpInputPanelV1Server {
    @discardableResult
    @MainActor
    func create<Owner: ZwpInputPanelV1Requests>(
        ...
        unsafe _create(vtable: ZwpInputPanelV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ZwpInputPanelV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ZwpInputPanelV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ZwpInputPanelV1Server.self,
