...
@MainActor public protocol ExtForeignToplevelListV1Requests: AnyObject {
...
public enum ExtForeignToplevelListV1Server: WaylandServerInterface {
...
public extension WaylandResourceHandle where Interface == ExtForeignToplevelListV1Server {
    @discardableResult
...
public extension WlNewId where Interface == ExtForeignToplevelListV1Server {
    @discardableResult
    @MainActor
    func create<Owner: ExtForeignToplevelListV1Requests>(
        ...
        unsafe _create(vtable: ExtForeignToplevelListV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ExtForeignToplevelListV1Server {
    @MainActor
