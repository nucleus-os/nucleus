...
package enum ExtForeignToplevelListV1Server: WaylandServerInterface {
    ...
    nonisolated(unsafe) package static let nativeRequestVtable: UnsafeRawPointer = {
        ...
        let raw = UnsafeMutableRawPointer.allocate(
            byteCount: size,
            alignment: MemoryLayout<swift_wayland_ext_foreign_toplevel_list_v1_requests>.alignment)
        unsafe raw.initializeMemory(as: UInt8.self, repeating: 0, count: size)
        let vt = unsafe raw.bindMemory(
            to: swift_wayland_ext_foreign_toplevel_list_v1_requests.self, capacity: 1)
        ...
        @convention(c) (OpaquePointer?, UnsafeMutablePointer<wl_resource>?) -> Void = { _, res in
            ...
            MainActor.assumeIsolated {
                unsafe requestHandler.stop(
                    WaylandRequest<ExtForeignToplevelListV1Server>(requestResource))
            }
        }
...
extension WaylandResourceHandle where Interface == ExtForeignToplevelListV1Server {
    ...
    @discardableResult
    package func createToplevel<Owner: AnyObject>(
...
extension WlNewId where Interface == ExtForeignToplevelListV1Server {
    ...
    package func create<Owner: ExtForeignToplevelListV1Requests>(
        ...
        unsafe _create(
            vtable: ExtForeignToplevelListV1Server.descriptor.nativeRequestVtable, owner: owner,
            installed: installed)
    }
}
extension ExtForeignToplevelListV1Server {
    ...
    package static func global<Implementation: AnyObject & ExtForeignToplevelListV1Requests>(
        ...
        installed:
            @escaping (Implementation, WaylandResourceHandle<ExtForeignToplevelListV1Server>) ->
            Void = { _, _ in
            }
    ...
    @MainActor
    package static func global<Implementation: AnyObject, Owner: ExtForeignToplevelListV1Requests>(
        implementation: Implementation,
        advertisedVersion: Int32 = maximumVersion,
        owner:
            @escaping (Implementation, WaylandResourceHandle<ExtForeignToplevelListV1Server>) ->
            Owner?,
        installed:
            @escaping (Implementation, Owner, WaylandResourceHandle<ExtForeignToplevelListV1Server>)
            -> Void = { _, _, _ in
            }
    ) -> WaylandGlobalSpecification<ExtForeignToplevelListV1Server> {
        unsafe WaylandGlobalSpecification(
