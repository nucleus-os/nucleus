            ...
            if let h = unsafe handler(res) {
                ...
                MainActor.assumeIsolated {
                    unsafe requestHandler.destroy(
                        WaylandRequest<ZxdgPopupV6Server>(requestResource))
                }
            } else {
...
package extension WlNewId where Interface == ZxdgPopupV6Server {
    ...
    package func create<Owner: ZxdgPopupV6Requests>(
        ...
        unsafe _create(
            vtable: ZxdgPopupV6Server.descriptor.nativeRequestVtable, owner: owner,
            installed: installed)
    }
}
package extension ZxdgPopupV6Server {
    ...
    package static func global<Implementation: AnyObject & ZxdgPopupV6Requests>(
        ...
        installed: @escaping (Implementation, WaylandResourceHandle<ZxdgPopupV6Server>) -> Void = {
            _, _ in
        }
    ...
    @MainActor
    package static func global<Implementation: AnyObject, Owner: ZxdgPopupV6Requests>(
        implementation: Implementation,
        advertisedVersion: Int32 = maximumVersion,
        owner: @escaping (Implementation, WaylandResourceHandle<ZxdgPopupV6Server>) -> Owner?,
        installed:
            @escaping (Implementation, Owner, WaylandResourceHandle<ZxdgPopupV6Server>) -> Void = {
                _, _, _ in
            }
    ) -> WaylandGlobalSpecification<ZxdgPopupV6Server> {
        unsafe WaylandGlobalSpecification(
