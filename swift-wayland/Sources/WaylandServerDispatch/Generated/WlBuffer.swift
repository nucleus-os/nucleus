...
package extension WlNewId where Interface == WlBufferServer {
    ...
    package func create<Owner: AnyObject>(
        ...
        unsafe _create(
            vtable: WlBufferServer.descriptor.nativeRequestVtable, owner: owner,
            installed: installed)
    }
}
package extension WlBufferServer {
    ...
    package static func global<Implementation: AnyObject & AnyObject>(
        ...
        installed: @escaping (Implementation, WaylandResourceHandle<WlBufferServer>) -> Void = {
            _, _ in
        }
    ...
    package static func global<Implementation: AnyObject, Owner: AnyObject>(
        ...
        installed:
            @escaping (Implementation, Owner, WaylandResourceHandle<WlBufferServer>) -> Void = {
                _, _, _ in
            }
    ) -> WaylandGlobalSpecification<WlBufferServer> {
        unsafe WaylandGlobalSpecification(
