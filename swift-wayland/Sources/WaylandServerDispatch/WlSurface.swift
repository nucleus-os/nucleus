...
@MainActor public protocol WlSurfaceRequests: AnyObject {
...
public enum WlSurfaceServer: WaylandServerInterface {
    ...
    public static func sendPreferredBufferTransform(_ target: UnsafeMutablePointer<wl_resource>, transform: WlOutputTransform) {
...
public extension WaylandResourceHandle where Interface == WlSurfaceServer {
...
public extension WaylandRequest where Interface == WlSurfaceServer {
...
public extension WlNewId where Interface == WlSurfaceServer {
    @discardableResult
    @MainActor
    func create<Owner: WlSurfaceRequests>(
        ...
        unsafe _create(vtable: WlSurfaceServer.requestVtable(), owner: owner, installed: installed)
    }
}
public extension WlSurfaceServer {
    @discardableResult
    @MainActor
    static func createResource<Owner: WlSurfaceRequests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: WlSurfaceServer.self,
