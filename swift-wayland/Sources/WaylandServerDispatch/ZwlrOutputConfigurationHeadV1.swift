...
@MainActor public protocol ZwlrOutputConfigurationHeadV1Requests: AnyObject {
...
public enum ZwlrOutputConfigurationHeadV1Server: WaylandServerInterface {
...
public extension WaylandRequest where Interface == ZwlrOutputConfigurationHeadV1Server {
    func postError(_ code: ZwlrOutputConfigurationHeadV1Error, message: String) {
        postError(code: code.rawValue, message: message)
    }
}
public extension WaylandResourceHandle where Interface == ZwlrOutputConfigurationHeadV1Server {
    @discardableResult
    func postError(_ code: ZwlrOutputConfigurationHeadV1Error, message: String) -> Bool {
        postError(code: code.rawValue, message: message)
    }
}
public extension WlNewId where Interface == ZwlrOutputConfigurationHeadV1Server {
    @discardableResult
    @MainActor
    func create<Owner: ZwlrOutputConfigurationHeadV1Requests>(
        ...
        unsafe _create(vtable: ZwlrOutputConfigurationHeadV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ZwlrOutputConfigurationHeadV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ZwlrOutputConfigurationHeadV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ZwlrOutputConfigurationHeadV1Server.self,
