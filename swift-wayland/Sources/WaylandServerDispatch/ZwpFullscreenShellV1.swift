...
public extension WlNewId where Interface == ZwpFullscreenShellV1Server {
    ...
    func create<Owner: ZwpFullscreenShellV1Requests>(
        ...
        unsafe _create(vtable: ZwpFullscreenShellV1Server.requestVtable(), owner: owner, installed: installed)
    }
}
public extension ZwpFullscreenShellV1Server {
    @discardableResult
    @MainActor
    static func createResource<Owner: ZwpFullscreenShellV1Requests>(
        ...
        unsafe WaylandResource.create(
            client: client, interface: ZwpFullscreenShellV1Server.self,
