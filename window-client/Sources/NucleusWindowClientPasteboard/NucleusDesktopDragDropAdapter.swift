...
///
/// Clipboard state intentionally lives in `NucleusDesktopPasteboardAdapter`.
...
@safe public final class NucleusDesktopDragDropAdapter {
    ...
    @safe private final class Offer: WlDataOfferEvents {
        ...
        weak var adapter: NucleusDesktopDragDropAdapter?
        ...
        init(
            ...
            adapter: NucleusDesktopDragDropAdapter
        ) throws {
            self.proxy = proxy
        ...
        func sourceActions(
            ...
            sourceActions =
                NucleusDesktopDragDropAdapter.operations(
        ...
        func action(
            ...
            selectedAction =
                NucleusDesktopDragDropAdapter.operation(
    ...
    private let seat: NucleusDesktopSeat
