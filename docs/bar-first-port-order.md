...
Phases 1 through 5 below are completed history. The native shell completion plan is
the sole execution authority for the remaining bar, native services, IPC-backed
product surfaces, panels, accessibility, and qualification work. Do not
