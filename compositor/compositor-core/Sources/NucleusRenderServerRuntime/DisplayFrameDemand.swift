...
/// render owners and the render active-animations fact.
...
final class DisplayFrameDemand {
    ...
    /// Collect current server render demand across output display links.
    func sync() {
        ...
        let animationActive = renderRuntime.hasActiveAnimations
