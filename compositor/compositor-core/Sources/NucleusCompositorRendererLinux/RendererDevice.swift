...
package struct RendererTopologyProposal:
    Sendable, Equatable
{
    package let generation: UInt64
    package let outputs: [RendererOutputInfo]
}
...
package enum RendererRetirementResult: Sendable, Equatable {
    case complete
    case draining
    case failed
}
...
package struct CompositeFenceTelemetry:
    Sendable, Equatable
{
    package var clientAcquireFenceCount: UInt64 = 0
    package var latestClientAcquireSignalNs: UInt64?
    package var renderCompleteNs: UInt64?
    package var gpuElapsedNs: UInt64?
