/**
 * Nucleus ModalHostView native component (Fabric name only).
 *
 * @flow
 * @format
 */
...
type ModalHostViewNativeProps = $ReadOnly<{
  ...ViewProps,
...
export default (codegenNativeComponent<ModalHostViewNativeProps>(
  'ModalHostView',
  {
    interfaceOnly: true,
  },
): HostComponent<ModalHostViewNativeProps>);
