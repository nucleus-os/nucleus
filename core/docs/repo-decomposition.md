...
native Vulkan (`collider bootstrap core`, `collider android native`).
...
(`collider bootstrap rn`, `collider generate rn-spec`).
...
`collider bootstrap`; components do not carry independent bootstrap scripts.
