...
/// (`enum(u64)`).
package struct TextureHandle: Equatable, Hashable, Sendable {
...
package enum SnapshotProvenance: Equatable, Sendable {
    case unknown
...
package struct SnapshotEntry: Equatable, Sendable {
    package var texture: TextureHandle
    package var size: Bounds
    package var provenance: SnapshotProvenance = .unknown
    package var refcount: UInt32 = 1
...
/// registry state.
package final class SnapshotService: Sendable {
    ...
    package var backdropCaptureBlocks: UInt64 {
    ...
    /// `resolve`.
    package func resolve(_ handle: SnapshotHandle) -> SnapshotEntry? {
    ...
    package func retain(_ handle: SnapshotHandle) {
    ...
    /// `release`.
    package func release(_ handle: SnapshotHandle) -> TextureHandle? {
        if handle.isNone { return nil }
    ...
    /// Mirrors `releaseAll`.
    package func releaseAll(_ releaser: (TextureHandle) -> Void) {
    ...
    package func registerTextureHandle(_ texture: TextureHandle, size: Bounds) -> SnapshotHandle {
    ...
    package func registerTextureHandle(
