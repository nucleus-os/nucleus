...
package struct OutputBufferOwner: ~Copyable {
...
package struct MailboxRing {
    ...
    package mutating func acquireSlot() -> Int {
        let slot = nextSlot
...
package struct ScanoutCopy: Equatable, Sendable {
    package var sourceGeneration: UInt64
    package var targetGeneration: UInt64
    package init(sourceGeneration: UInt64, targetGeneration: UInt64) {
