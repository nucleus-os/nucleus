...
function processChildren(children: React.ReactNode, actionMap: ActionMap): AppMenuItem[] {
...
function processMenus(children: React.ReactNode, actionMap: ActionMap): AppMenuConfig[] {
